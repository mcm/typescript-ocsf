...
import { AuthFactor, type AuthFactorType } from "./auth_factor.js";
import { Fingerprint, type FingerprintType } from "./fingerprint.js";
import { Scim, type ScimType } from "./scim.js";
import { Sso, type SsoType } from "./sso.js";
...
export interface IdpType {
  ...
  fingerprint?: FingerprintType | undefined;
...
export const Idp: z.ZodType<IdpType> = z
  .object({
    /** The name of the Identity Provider. */
