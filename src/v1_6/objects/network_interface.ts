...
import { PortInfo, type PortInfoType } from "./port_info.js";
...
export interface NetworkInterfaceType {
  ...
  open_ports?: PortInfoType[] | undefined;
  ...
  subnet_prefix?: number | undefined;
...
export const NetworkInterface: z.ZodType<NetworkInterfaceType> = z
  .object({
    /** The name of the network interface. */
