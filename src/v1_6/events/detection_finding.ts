...
import { AnomalyAnalysis, type AnomalyAnalysisType } from "../objects/anomaly_analysis.js";
...
import { MalwareScanInfo, type MalwareScanInfoType } from "../objects/malware_scan_info.js";
...
export interface DetectionFindingType {
  ...
  anomaly_analyses?: AnomalyAnalysisType[] | undefined;
  ...
  malware_scan_info?: MalwareScanInfoType | undefined;
...
export const DetectionFinding: z.ZodType<DetectionFindingType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** Describes baseline information about normal activity patterns, along with any detected deviations or anomalies that triggered this finding. */
      anomaly_analyses: z.array(z.lazy(() => AnomalyAnalysis)).optional(),
      /** Describes various evidence artifacts associated to the activity/activities that triggered a security detection. */
      ...
      /** Describes details about malware scan job that triggered this Detection Finding. */
      malware_scan_info: z.lazy(() => MalwareScanInfo).optional(),
      /** Describes the recommended remediation steps to address identified issue(s). */
