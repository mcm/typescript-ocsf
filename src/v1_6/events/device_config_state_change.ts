...
import { SecurityState, type SecurityStateType } from "../objects/security_state.js";
...
const SIBLING_PAIRS: readonly SiblingPair[] = [
  ...
  {
    idField: "prev_security_level_id",
    labelField: "prev_security_level",
    labels: PREV_SECURITY_LEVEL_ID_LABELS,
  },
...
export interface DeviceConfigStateChangeType {
  ...
  prev_security_level?: string | undefined;
  /** The previous security level of the entity */
  prev_security_level_id?: number | undefined;
  /** The previous security states of the device. */
  prev_security_states?: SecurityStateType[] | undefined;
  /** The current security level of the entity */
  security_level?: string | undefined;
  /** The current security level of the entity */
  security_level_id?: number | undefined;
  /** The current security states of the device. */
  security_states?: SecurityStateType[] | undefined;
...
export const DeviceConfigStateChange: z.ZodType<DeviceConfigStateChangeType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The previous security level of the entity */
      prev_security_level_id: z.number().int().optional(),
      /** The previous security states of the device. */
      prev_security_states: z.array(z.lazy(() => SecurityState)).optional(),
      /** The current security level of the entity */
      security_level: z.string().optional(),
      /** The current security level of the entity */
      security_level_id: z.number().int().optional(),
      /** The current security states of the device. */
      security_states: z.array(z.lazy(() => SecurityState)).optional(),
      /** The Config Change Stat, normalized to the caption of the state_id value. In the case of 'Other', it is defined by the source. */
