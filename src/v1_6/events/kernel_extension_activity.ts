...
import { KernelDriver, type KernelDriverType } from "../objects/kernel_driver.js";
...
export const KernelExtensionActivity: z.ZodType<KernelExtensionActivityType> = z.preprocess(
  (data) => {
