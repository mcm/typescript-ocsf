...
import { Package, type PackageType } from "../objects/package.js";
import { Product, type ProductType } from "../objects/product.js";
import { Sbom, type SbomType } from "../objects/sbom.js";
...
export const SoftwareInfo: z.ZodType<SoftwareInfoType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The device software that is being discovered by an inventory process. */
      package: z.lazy(() => Package).optional(),
      /** Additional product attributes that have been discovered or enriched from a catalog or other external source. */
      product: z.lazy(() => Product).optional(),
      /** The Software Bill of Materials (SBOM) of the device software that is being discovered by an inventory process. */
      sbom: z.lazy(() => Sbom).optional(),
    })
    .passthrough(),
) as any;
