...
export interface FileActivityType {
  ...
  file_diff?: string | undefined;
  /** The resulting file object when the activity was allowed and successful. */
  file_result?: FileType | undefined;
  [key: string]: unknown;
}

export const FileActivity: z.ZodType<FileActivityType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The resulting file object when the activity was allowed and successful. */
      file_result: z.lazy(() => File).optional(),
    })
    .passthrough(),
) as any;
