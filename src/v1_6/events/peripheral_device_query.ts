...
import { PeripheralDevice, type PeripheralDeviceType } from "../objects/peripheral_device.js";
...
export const PeripheralDeviceQuery: z.ZodType<PeripheralDeviceQueryType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The peripheral device that triggered the event. */
      peripheral_device: z.lazy(() => PeripheralDevice),
    })
    .passthrough(),
) as any;
