...
} from "../objects/authentication_token.js";
import { Certificate, type CertificateType } from "../objects/certificate.js";
...
const SIBLING_PAIRS: readonly SiblingPair[] = [
  ...
  {
    idField: "account_switch_type_id",
    labelField: "account_switch_type",
    labels: ACCOUNT_SWITCH_TYPE_ID_LABELS,
  },
...
export interface AuthenticationType {
  ...
  account_switch_type?: string | undefined;
  /** The normalized identifier of the account switch method. */
  account_switch_type_id?: number | undefined;
  ...
  authentication_token?: AuthenticationTokenType | undefined;
  ...
  is_cleartext?: boolean | undefined;
  ...
  is_new_logon?: boolean | undefined;
  ...
  logon_process?: ProcessType | undefined;
  ...
  logon_type?: string | undefined;
  /** The normalized logon type identifier. */
  logon_type_id?: number | undefined;
...
export const Authentication: z.ZodType<AuthenticationType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The authentication token, ticket, or assertion, e.g. Kerberos, OIDC, SAML. */
      authentication_token: z.lazy(() => AuthenticationToken).optional(),
      /** The certificate associated with the authentication or pre-authentication (Kerberos). */
      certificate: z.lazy(() => Certificate).optional(),
      /** The endpoint to which the authentication was targeted. */
      ...
      /** The trusted process that validated the authentication credentials. */
      logon_process: z.lazy(() => Process).optional(),
      /** The logon type, normalized to the caption of the logon_type_id value. In the case of 'Other', it is defined by the event source. */
      logon_type: z.string().optional(),
      /** The normalized logon type identifier. */
      logon_type_id: z.number().int().optional(),
      /** The service or gateway to which the user or process is being authenticated */
      service: z.lazy(() => Service).optional(),
      /** The authenticated user or service session. */
