...
import { Assessment, type AssessmentType } from "../objects/assessment.js";
import {
  CisBenchmarkResult,
  type CisBenchmarkResultType,
} from "../objects/cis_benchmark_result.js";
...
export interface ConfigStateType {
  ...
  assessments?: AssessmentType[] | undefined;
  ...
  cis_benchmark_result?: CisBenchmarkResultType | undefined;
  /** The device that is being discovered by an inventory process. */
  device: DeviceType;
  [key: string]: unknown;
}

export const ConfigState: z.ZodType<ConfigStateType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** A list of assessments associated with the device. */
      assessments: z.array(z.lazy(() => Assessment)).optional(),
      /** The CIS Benchmark Result object captures results generated from benchmark evaluations as defined by the Center for Internet Security (CIS). */
      cis_benchmark_result: z.lazy(() => CisBenchmarkResult).optional(),
      /** The device that is being discovered by an inventory process. */
