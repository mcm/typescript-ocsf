...
import { DataSecurityFindingActivityId } from '../enums/data_security_finding_activity_id.js';
...
const DataSecurityFindingSchema = z.strictObject({
  /** The normalized identifier of the Data Security Finding activity. */
...
export const DataSecurityFinding = {
  ...
  ActivityId: DataSecurityFindingActivityId,
