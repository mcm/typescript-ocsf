...
import { Osint, type OsintType } from "../objects/osint.js";
...
export const OsintInventoryInfo: z.ZodType<OsintInventoryInfoType> = z.preprocess(
  (data) => {
