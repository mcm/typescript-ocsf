 ...
 */
export interface DeviceConfigStateChangeType {
  ...
  /** The previous security level of the entity */
  prev_security_level_id?: 0 | 1 | 2 | 3 | 99;
  /** The previous security states of the device. */
  prev_security_states?: SecurityStateType[];
  /** The current security level of the entity */
  security_level?: string;
  /** The current security level of the entity */
  security_level_id?: 0 | 1 | 2 | 3 | 99;
  /** The current security states of the device. */
  security_states?: SecurityStateType[];
...
import { SecurityState } from '../objects/security_state.js';
...
const PREV_SECURITY_LEVEL_ID_LABELS: Record<number, string> = {
  0: "Unknown",
  1: "Secure",
  2: "At Risk",
  3: "Compromised",
...
const SECURITY_LEVEL_ID_LABELS: Record<number, string> = {
  0: "Unknown",
  1: "Secure",
  2: "At Risk",
  3: "Compromised",
...
const SIBLING_PAIRS: readonly SiblingPair[] = [
  ...
  { idField: "prev_security_level_id", labelField: "prev_security_level", labels: PREV_SECURITY_LEVEL_ID_LABELS },
  { idField: "security_level_id", labelField: "security_level", labels: SECURITY_LEVEL_ID_LABELS },
...
const DeviceConfigStateChangeSchema: z.ZodType<DeviceConfigStateChangeType> = z.strictObject({
  ...
  device: Device,
  /** The previous security level of the entity */
  prev_security_level: z.string().optional(),
  /** The previous security level of the entity */
  prev_security_level_id: z.union([z.literal(0), z.literal(1), z.literal(2), z.literal(3), z.literal(99)]).optional(),
  /** The previous security states of the device. */
  prev_security_states: z.array(SecurityState).optional(),
  /** The current security level of the entity */
  security_level: z.string().optional(),
  /** The current security level of the entity */
  security_level_id: z.union([z.literal(0), z.literal(1), z.literal(2), z.literal(3), z.literal(99)]).optional(),
  /** The current security states of the device. */
  security_states: z.array(SecurityState).optional(),
  /** The Config Change Stat, normalized to the caption of the state_id value. In the case of 'Other', it is defined by the source. */
  state: z.string().optional(),
  /** The Config Change State of the managed entity. */
  state_id: z.union([z.literal(0), z.literal(1), z.literal(2), z.literal(99)]).optional(),
});

export const DeviceConfigStateChange = {
  parse: (data: unknown): DeviceConfigStateChangeType => DeviceConfigStateChangeSchema.parse(preprocess(data)),

  safeParse: (data: unknown): { success: true; data: DeviceConfigStateChangeType } | { success: false; error: z.ZodError } => {
    try {
      const preprocessed = preprocess(data);
      return DeviceConfigStateChangeSchema.safeParse(preprocessed);
    } catch (error) {
