/** ProcessRemediationActivity activity_id values. */
export const ProcessRemediationActivityActivityId = {
  UNKNOWN: 0,
...
export const ProcessRemediationActivityActivityIdByLabel: Record<string, number> = {
  "Unknown": 0,
  "Isolate": 1,
  "Evict": 2,
  "Restore": 3,
