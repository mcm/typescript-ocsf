...
export interface UnmannedAerialSystemType {
  ...
  speed_accuracy?: string | undefined;
  ...
  track_direction?: string | undefined;
  ...
  vertical_speed?: string | undefined;
...
export const UnmannedAerialSystem: z.ZodType<UnmannedAerialSystemType> = z
  .object({
    /** The name of the unmanned system as reported by tracking or sensing hardware. */
