 ...
 */
export interface LdapPersonType {
...
export const LdapPerson: z.ZodType<LdapPersonType> = z.lazy(() =>
  z
    .object({
      /** The cost center associated with the user. */
      ...
      /** The list of tags; {key:value} pairs associated to the user. */
      tags: z.array(z.lazy(() => KeyValueObject)).optional(),
    })
    .passthrough(),
) as any;
