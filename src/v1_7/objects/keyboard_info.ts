...
export interface KeyboardInfoType {
  ...
  function_keys?: number | undefined;
  /** The Input Method Editor (IME) file name. */
  ime?: string | undefined;
  /** The keyboard locale identifier name (e.g., en-US). */
  keyboard_layout?: string | undefined;
  /** The keyboard numeric code. */
  keyboard_subtype?: number | undefined;
  /** The keyboard type (e.g., xt, ico). */
  keyboard_type?: string | undefined;
  [key: string]: unknown;
}

export const KeyboardInfo: z.ZodType<KeyboardInfoType> = z
  .object({
    /** The number of function keys on client keyboard. */
