...
import { Assessment, type AssessmentType } from "./assessment.js";
import { Check, type CheckType } from "./check.js";
...
export interface ComplianceType {
  ...
  control_parameters?: KeyValueObjectType[] | undefined;
...
export const Compliance: z.ZodType<ComplianceType> = z
  .object({
    /** A list of assessments associated with the compliance requirements evaluation. */
