...
export type EmailFileActivityActivityId = (typeof EmailFileActivityActivityId)[keyof typeof EmailFileActivityActivityId];
...
export const EmailFileActivityActivityIdByLabel: Record<string, number> = {
  "Unknown": 0,
  "Send": 1,
  "Receive": 2,
  "Scan": 3,
