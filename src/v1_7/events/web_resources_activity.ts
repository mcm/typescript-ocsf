...
import { WebResource, type WebResourceType } from "../objects/web_resource.js";
...
export interface WebResourcesActivityType {
  ...
  web_resources_result?: WebResourceType[] | undefined;
  [key: string]: unknown;
}

export const WebResourcesActivity: z.ZodType<WebResourcesActivityType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** Describes details about web resources that were affected by an activity/event. */
      web_resources: z.array(z.lazy(() => WebResource)),
      /** The results of the activity on web resources. It should contain the new values of the changed attributes of the web resources. */
      web_resources_result: z.array(z.lazy(() => WebResource)).optional(),
    })
    .passthrough(),
) as any;
