...
import { Policy, type PolicyType } from "../objects/policy.js";
import { Scan, type ScanType } from "../objects/scan.js";
 ...
 */
export interface ScanActivityType {
  ...
  schedule_uid?: string | undefined;
  /** The total number of items that were scanned; zero if no items were scanned. */
  total?: number | undefined;
  [key: string]: unknown;
}

export const ScanActivity: z.ZodType<ScanActivityType> = z.preprocess(
  (data) => {
