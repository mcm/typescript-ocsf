...
import { QueryEvidence, type QueryEvidenceType } from "../objects/query_evidence.js";
...
export const EvidenceInfo: z.ZodType<EvidenceInfoType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The specific resulting evidence information that was queried or discovered based on the query type. Contains various child objects corresponding to the query_type_id values. */
      query_evidence: z.lazy(() => QueryEvidence),
    })
    .passthrough(),
) as any;
