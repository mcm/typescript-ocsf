 ...
 */
export interface FtpActivityType {
  ...
  command_responses?: string[] | undefined;
...
export const FtpActivity: z.ZodType<FtpActivityType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The list of responses to the FTP command. */
      command_responses: z.array(z.string()).optional(),
      /** The file that is the target of the FTP activity. */
