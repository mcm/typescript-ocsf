...
import { DnsAnswer, type DnsAnswerType } from "../objects/dns_answer.js";
import { DnsQuery, type DnsQueryType } from "../objects/dns_query.js";
...
export interface DnsActivityType {
  ...
  rcode_id?: number | undefined;
  /** The Domain Name System (DNS) response time. */
  response_time?: number | undefined;
  [key: string]: unknown;
}

export const DnsActivity: z.ZodType<DnsActivityType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The Domain Name System (DNS) answers. */
      answers: z.array(z.lazy(() => DnsAnswer)).optional(),
      /** The Domain Name System (DNS) query. */
      query: z.lazy(() => DnsQuery).optional(),
      /** The Domain Name System (DNS) query time. */
