...
import { KbArticle, type KbArticleType } from "../objects/kb_article.js";
...
export const PatchState: z.ZodType<PatchStateType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** A list of KB articles or patches related to an endpoint. A KB Article contains metadata that describes the patch or an update. */
      kb_article_list: z.array(z.lazy(() => KbArticle)).optional(),
    })
    .passthrough(),
) as any;
