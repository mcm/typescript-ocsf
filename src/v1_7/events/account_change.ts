...
import { AuthFactor, type AuthFactorType } from "../objects/auth_factor.js";
...
export interface AccountChangeType {
  ...
  auth_factors?: AuthFactorType[] | undefined;
  ...
  user_result?: UserType | undefined;
  [key: string]: unknown;
}

export const AccountChange: z.ZodType<AccountChangeType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** Details about the authentication factors associated with the MFA Factor Enable/Disable activities. */
      auth_factors: z.array(z.lazy(() => AuthFactor)).optional(),
      /** Details about the IAM policies associated with the Attach/Detach Policy activities. */
      policies: z.array(z.lazy(() => Policy)).optional(),
      /** Details about the IAM policy associated to the Attach/Detach Policy activities. */
      policy: z.lazy(() => Policy).optional(),
      /** The user that was a target of an activity. */
      user: z.lazy(() => User),
      /** The result of the user account change. It should contain the new values of the changed attributes. */
      user_result: z.lazy(() => User).optional(),
    })
    .passthrough(),
) as any;
