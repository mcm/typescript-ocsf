 ...
 */
export interface DhcpActivityType {
  ...
  lease_dur?: number | undefined;
  /** The network relay that is associated with the event. */
  relay?: NetworkInterfaceType | undefined;
...
export const DhcpActivity: z.ZodType<DhcpActivityType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The network relay that is associated with the event. */
      relay: z.lazy(() => NetworkInterface).optional(),
      /** The unique identifier of the transaction. This is typically a random number generated from the client to associate a dhcp request/response pair. */
