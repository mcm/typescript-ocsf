...
import { StartupItem, type StartupItemType } from "../objects/startup_item.js";
...
export const StartupItemQuery: z.ZodType<StartupItemQueryType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The startup item object describes an application component that has associated startup criteria and configurations. */
      startup_item: z.lazy(() => StartupItem),
    })
    .passthrough(),
) as any;
