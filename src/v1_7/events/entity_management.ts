...
import { ManagedEntity, type ManagedEntityType } from "../objects/managed_entity.js";
...
export interface EntityManagementType {
  ...
  entity_result?: ManagedEntityType | undefined;
  [key: string]: unknown;
}

export const EntityManagement: z.ZodType<EntityManagementType> = z.preprocess(
  (data) => {
  ...
  z
    .object({
      ...
      /** The managed entity that is being acted upon. */
      entity: z.lazy(() => ManagedEntity),
      /** The updated managed entity. */
      entity_result: z.lazy(() => ManagedEntity).optional(),
    })
    .passthrough(),
) as any;
