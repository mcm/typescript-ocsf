 ...
 */
export interface NetworkActivityType {
  ...
  is_src_dst_assignment_known?: boolean | undefined;
  /** The URL details relevant to the network traffic. */
  url?: UrlType | undefined;
  [key: string]: unknown;
}

export const NetworkActivity: z.ZodType<NetworkActivityType> = z.preprocess(
  (data) => {
